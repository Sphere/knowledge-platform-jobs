...
case class CertificateExtension(@JsonProperty("@context") context: String, related: Option[Array[String]] = None, version: Option[String] = None, endorsement: Option[Endorsement] = None,
                                ...
                                var printUri: Option[String] = None, validFrom: String, var signature: Option[Signature] = None, var rmNumber: Option[String] = None, var orgName: Option[String] = None, var country: Option[String] = None, var state: Option[String] = None, var district: Option[String] = None, providerName: String, var maxScore: Option[String] = None)
