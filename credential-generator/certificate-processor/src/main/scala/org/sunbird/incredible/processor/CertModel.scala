...
case class CertModel(courseName: String, recipientName: String, recipientId: Option[String] = None, recipientEmail: Option[String] = None, recipientPhone: Option[String] = None
                     ...
                     keyId: String = "", tag: String = "", rmNumber: String = "", orgName: String = "", country: String = "", state: String = "", district: String = "", block: String = "",
                     designation: String = "", facilityName: String = "", nin: String = "", providerName: String = "", maxScore: String = "")
